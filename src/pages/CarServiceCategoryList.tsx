...
import { fetchCarServiceCategoryList, fetchCarCategoryList, createOrUpdateCarServiceCategory, deleteCarServiceCategory, newwork_image_url } from '../utilities/api';
import type { CarServiceCategoryItem, CarCategoryItem } from '../utilities/api';
