...
import { AuthContextTrippy } from '../hooks/useAuth';
...
export const translations = {
  en: {
    ...
    commissionInsurance: 'Commission & Insurance',
  ...
  bn: {
    ...
    commissionInsurance: 'কমিশন ও ইন্স্যুরেন্স',
    userSetting: 'ব্যবহারকারী সেটিংস',
    otpSetup: 'ওটিপি সেটআপ',
    privacyPolicy: 'গোপনীয়তা নীতি ও শর্তাবলী',
    apiKey: 'এপিআই কি',
